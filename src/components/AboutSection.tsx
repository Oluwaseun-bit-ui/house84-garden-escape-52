      ...
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            {features.map((feature, index) => <div key={index} className="text-center p-8 rounded-2xl bg-secondary hover:bg-secondary/80 transition-colors group">
          ...
          <div className="text-center bg-gradient-to-r from-garden-green/10 to-garden-sage/10 rounded-3xl p-8 md:p-12">
            ...
            <cite className="block mt-6 text-lg text-muted-foreground not-italic">— House 84 Parks & Garden Team</cite>
          </div>
        </div>
      </div>
    </section>;
